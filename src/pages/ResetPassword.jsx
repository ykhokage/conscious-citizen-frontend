...
export default function ResetPassword() {
  ...
  const { login } = useAuth();
  const [email, setEmail] = useState(localStorage.getItem("pendingEmail") || localStorage.getItem("lastEmail") || "");
      ...
      >
        <form onSubmit={submit} className="grid gap-4 md:grid-cols-2">
          ...
          <div className="md:col-span-2 flex flex-wrap gap-3 pt-2">
            ...
            <Button type="button" variant="ghost" size="lg" onClick={resendCode} disabled={busy}>
